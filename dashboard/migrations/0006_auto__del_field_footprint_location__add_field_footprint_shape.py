...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Footprint.location'
        db.delete_column(u'dashboard_footprint', 'location')

        # Adding field 'Footprint.shape'
        db.add_column(u'dashboard_footprint', 'shape',
                      self.gf('django.contrib.gis.db.models.fields.GeometryField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Footprint.location'
        db.add_column(u'dashboard_footprint', 'location',
                      self.gf('django.contrib.gis.db.models.fields.GeometryField')(null=True),
                      keep_default=False)

        # Deleting field 'Footprint.shape'
        db.delete_column(u'dashboard_footprint', 'shape')
