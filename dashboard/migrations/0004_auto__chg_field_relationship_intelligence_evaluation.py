...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Relationship.intelligence_evaluation'
        db.alter_column(u'dashboard_relationship', 'intelligence_evaluation', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

    def backwards(self, orm):

        # Changing field 'Relationship.intelligence_evaluation'
        db.alter_column(u'dashboard_relationship', 'intelligence_evaluation', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))
