...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'dashboard_messages')

        # Removing M2M table for field events on 'Messages'
        db.delete_table(db.shorten_name(u'dashboard_messages_events'))
        ...
        # Adding M2M table for field events on 'Message'
        m2m_table_name = db.shorten_name(u'dashboard_message_events')
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'dashboard_messages', (
            ('content', self.gf('django.db.models.fields.CharField')(max_length=1000)),
            ('uid', self.gf('django.db.models.fields.IntegerField')()),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'dashboard', ['Messages'])

        # Adding M2M table for field events on 'Messages'
        m2m_table_name = db.shorten_name(u'dashboard_messages_events')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('messages', models.ForeignKey(orm[u'dashboard.messages'], null=False)),
            ('event', models.ForeignKey(orm[u'dashboard.event'], null=False))
        ))
        db.create_unique(m2m_table_name, ['messages_id', 'event_id'])

        # Deleting model 'Message'
        db.delete_table(u'dashboard_message')

        # Removing M2M table for field events on 'Message'
        db.delete_table(db.shorten_name(u'dashboard_message_events'))
    ...
    models = {
        ...
        u'dashboard.message': {
            ...
            'events': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['dashboard.Event']", 'null': 'True', 'symmetrical': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
