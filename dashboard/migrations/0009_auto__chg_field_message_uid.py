...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Message.uid'
        db.alter_column(u'dashboard_message', 'uid', self.gf('django.db.models.fields.CharField')(max_length=10))

    def backwards(self, orm):

        # Changing field 'Message.uid'
        db.alter_column(u'dashboard_message', 'uid', self.gf('django.db.models.fields.IntegerField')())
