...
describe('Util.contains()', function() {
  it('should return true when called on itself', function() {
    var text;
    text = document.createTextNode("This is a test text");
    return assert.isTrue(Util.contains(text, text));
  });
  it('should return false on independent elements', function() {
    var div1, div2;
    div1 = document.createElement("div");
    div2 = document.createElement("div");
    return assert.isFalse(Util.contains(div1, div2));
  });
  it('should return true on immediate children, but not on parent', function() {
    var div1, div2;
    div1 = document.createElement("div");
    div2 = document.createElement("div");
    div1.appendChild(div2);
    assert.isTrue(Util.contains(div1, div2));
    return assert.isFalse(Util.contains(div2, div1));
  });
  return it('should return true on grand-children, but not on grand-parent', function() {
    var div1, div2, div3;
    div1 = document.createElement("div");
    div2 = document.createElement("div");
    ...
    return assert.isFalse(Util.contains(div3, div1));
  });
});
