...
(function() {
  ...
  Delegator._parseEvents = function(eventsObj) {
    var event, events, functionName, sel, selector, _i, _ref1;
    events = [];
  ...
  */
  ...
  if (!(typeof jQuery !== "undefined" && jQuery !== null ? (_ref1 = jQuery.fn) != null ? _ref1.jquery : void 0 : void 0)) {
  ...
  Util.flatten = function(array) {
    ...
    flatten = function(ary) {
      var el, flat, _k, _len2;
      flat = [];
      for (_k = 0, _len2 = ary.length; _k < _len2; _k++) {
        el = ary[_k];
  ...
  Util.nodeFromXPath = function(xp, root) {
    var idx, name, node, step, steps, _k, _len2, _ref2;
  ...
  Util.mousePosition = function(e, offsetEl) {
    var offset, _ref2;
    if ((_ref2 = $(offsetEl).css('position')) !== 'absolute' && _ref2 !== 'fixed' && _ref2 !== 'relative') {
  ...
  findChild = function(node, type, index) {
    var child, children, found, name, _k, _len2;
