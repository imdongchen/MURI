...
function AuthorizationHandler(storage) {
  ...
  this.tokenPrefix = 'ishout:token:';
  this.groupPrefix = 'ishout:group:';
}
...
function EventHandler(storage){
  this.storage = storage;
  this.channel =  'ishout:event_listener';
}
...
function createAPIServer(storage){
  ...
  // given a room name, return all user IDs connected to this room.
  internalServer.get('/status/room/:roomName', function(req, res) {
    var room = rooms.getRoom(req.params.roomName, storage);
