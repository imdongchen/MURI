SIIL.Map = function(div) {
    ...
    function showDetails(feature) {
        $("#footprint_popup .category").val(feature.category);
        $("#footprint_popup .precision").val(feature.precision);
        $("#footprint_popup .description").val(feature.description);
        ...
        thisCtrl.map.addPopup(feature.popup, true);
    }
