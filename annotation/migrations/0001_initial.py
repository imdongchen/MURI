...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'annotation_annotation', (
            ...
            ('dataentry', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dashboard.DataEntry'])),
            ('entity', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dashboard.Entity'], null=True, blank=True)),
    ...
    models = {
        u'annotation.annotation': {
            ...
            'dataentry': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['dashboard.DataEntry']"}),
            'end': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'endOffset': ('django.db.models.fields.IntegerField', [], {}),
            'entity': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['dashboard.Entity']", 'null': 'True', 'blank': 'True'}),
        ...
        u'dashboard.attribute': {
            'Meta': {'unique_together': "(('attr', 'val'),)", 'object_name': 'Attribute'},
            'attr': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'val': ('django.db.models.fields.CharField', [], {'max_length': '255'})
        },
        u'dashboard.dataentry': {
            'Meta': {'object_name': 'DataEntry'},
            'content': ('django.db.models.fields.TextField', [], {}),
            'dataset': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['dashboard.Dataset']", 'null': 'True', 'blank': 'True'}),
        ...
        u'dashboard.entity': {
            ...
            'attributes': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['dashboard.Attribute']", 'null': 'True', 'blank': 'True'}),
